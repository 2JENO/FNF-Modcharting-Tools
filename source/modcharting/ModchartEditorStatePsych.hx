...
class ModchartEditorState extends #if (PSYCH && PSYCHVERSION >= "0.7") backend.MusicBeatState #else MusicBeatState #end
{
   ...
   //pain
	...
	if(FlxG.sound.music != null)
        ...
        UI_box = new PsychUIBox(100, gridSize*2, FlxG.width-200, 550, [
            'Editor',
            'Modifiers',
            'Events',
            'Playfields'
 ...
 */
        var songSlider = new PsychUISlider(20, 200, function(fuck:Float)
        {
            vocals.time = inst.time;
            inst.time = fuck;
		...
		songSlider.maxText.visible = false;
		songSlider.minText.visible = false;
 ...
 */
    ...
    function addUI(tab_group:flixel.group.FlxSpriteGroup, name:String, ui:FlxSprite, title:String = "", body:String = "", anchor:Anchor = null)
    {
        tooltips.add(ui, {
			title: title,
			body: body,
